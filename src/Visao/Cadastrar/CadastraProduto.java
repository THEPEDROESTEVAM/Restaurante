...
public class CadastraProduto extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jComboBox1.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Massas", "Sobremesas", "Bebidas", "Refeições" }));
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        String porcao = jTextField4.getText();
        double valor = 
        String categoria = jComboBox1.getSelectedItem().toString();

        if(produto.equals("") || porcao.equals("") || categoria.equals("")){
